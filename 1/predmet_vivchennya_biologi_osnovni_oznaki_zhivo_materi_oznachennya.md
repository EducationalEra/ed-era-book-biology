...
**Тропiзми** <span class="p1">мають певне
    спрямування</span>, залежно від подразника. Розрізняють **позитивні тропізми (у бік подразника)** та **негативні (рух від подразника).** Наприклад,
    корені виявляють позитивний гідротропізм, тобто ростуть у той бік, в
    якому знаходиться вода.<br/> 
