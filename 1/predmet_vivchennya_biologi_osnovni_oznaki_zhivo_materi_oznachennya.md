...
**Тропiзми** <span class="p1">мають певне
    спрямування</span>, залежно від подразника. Розрізняють **позитивні тропізми (у бік подразника)** та **негативні (рух від подразника).** 
<div class="alg-wrap">
<span class="alg">Наприклад</span>
<div class="alg-text">
